...
void atrousFilterCudaTileAligned(GBuffer<uchar4> frame, int depth, FilterParams params, cudaStream_t stream){
...
KERNEL void atrousFilterCudaKernelTileAligned(const uchar4* in, uchar4* out, int level, GBuffer<uchar4> frame, FilterParams params){
...
CUDA_FUNC void atrousFilterPixelTileAligned(int2 pos, uchar4* tile, const uchar4* in, uchar4* out, int level, GBuffer<uchar4> frame, FilterParams params){
