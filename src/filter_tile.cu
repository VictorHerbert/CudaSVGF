...
void atrousFilterCudaTile(GFrame<uchar4> frame, int depth, FilterParams params, cudaStream_t stream){
...
KERNEL void atrousFilterCudaKernelTile(const uchar4* in, uchar4* out, int level, GFrame<uchar4> frame, FilterParams params){
...
CUDA_FUNC void atrousFilterPixelTile(int2 pos, uchar4* tile, const uchar4* in, uchar4* out, int level, GFrame<uchar4> frame, FilterParams params){
